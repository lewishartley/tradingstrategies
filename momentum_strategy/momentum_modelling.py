...
rf_classification_scores.to_sql("classification_scores", con = engine, if_exists = "replace")
...
rf_regression_scores.to_sql("regression_scores", con = engine, if_exists = "replace")

print(rf_classification_scores)
print(rf_regression_scores)
